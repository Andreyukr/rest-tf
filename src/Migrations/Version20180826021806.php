 ...
 */
final class Version20180826021806 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE customer_selection (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, personal_id INT NOT NULL, confirmed TINYINT(1) DEFAULT NULL, print_form_status VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE customer_selection');
