 ...
 */
final class Version20180826035227 extends AbstractMigration
{
...
/*
       ...
       */
        $this->addSql('ALTER TABLE customer_selection CHANGE print_form_status print_form_status TINYINT(1) DEFAULT NULL');
      /*
    ...
    */
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer_selection CHANGE print_form_status print_form_status VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
